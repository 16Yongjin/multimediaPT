...
public class lecture11Activity extends AppCompatActivity {
            ...
            switch (getArguments().getInt(ARG_SECTION_NUMBER)) {
                case 1:
                    ...
                    playBtn.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            String steamName = "@raw/streamsound" + "11";
                ...
                case 2:
                    ...
                    playBtn.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            String steamName = "@raw/streamsound" + "12";
                            final int streamID = getResources().getIdentifier(steamName, "raw", packName);
                            Player.getInstance().play(getActivity(), streamID);
                        }
                    });
                ...
                case 3:
                    ...
                    playBtn.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            String steamName = "@raw/streamsound" + "13";
                            final int streamID = getResources().getIdentifier(steamName, "raw", packName);
                            Player.getInstance().play(getActivity(), streamID);
                        }
                    });
