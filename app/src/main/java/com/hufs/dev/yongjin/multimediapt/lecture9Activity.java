...
public class lecture9Activity extends AppCompatActivity {
            ...
            switch (getArguments().getInt(ARG_SECTION_NUMBER)) {
                case 1:
                    ...
                    playBtn.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            String steamName = "@raw/streamsound" + "5";
                ...
                case 2:
                    ...
                    playBtn.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            String steamName = "@raw/streamsound" + "6";
                            final int streamID = getResources().getIdentifier(steamName, "raw", packName);
                            Player.getInstance().play(getActivity(), streamID);
                        }
                    });
                ...
                case 3:
                    ...
                    playBtn.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            String steamName = "@raw/streamsound" + "7";
                            final int streamID = getResources().getIdentifier(steamName, "raw", packName);
                            Player.getInstance().play(getActivity(), streamID);
                        }
                    });
