...
public class lecture8Activity extends AppCompatActivity {
            ...
            switch (getArguments().getInt(ARG_SECTION_NUMBER)) {
                case 1:
                    ...
                    playBtn.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            String steamName = "@raw/streamsound" + "1";
                ...
                case 2:
                    ...
                    playBtn.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            String steamName = "@raw/streamsound" + "2";
                            final int streamID = getResources().getIdentifier(steamName, "raw", packName);
                            Player.getInstance().play(getActivity(), streamID);
                        }
                    });
                ...
                case 3:
                    ...
                    playBtn.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            String steamName = "@raw/streamsound" + "3";
                            final int streamID = getResources().getIdentifier(steamName, "raw", packName);
                            Player.getInstance().play(getActivity(), streamID);
                        }
                    });
                ...
                case 4:
                    ...
                    playBtn.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            String steamName = "@raw/streamsound" + "4";
                            final int streamID = getResources().getIdentifier(steamName, "raw", packName);
                            Player.getInstance().play(getActivity(), streamID);
                        }
                    });
